          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 mb-10">
                <a href="tel:+359883317785" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-medium group-hover:text-primary transition-colors">+359 883 317 785</p>
                  </div>
                </a>
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-medium group-hover:text-primary transition-colors">Message us directly</p>
                  </div>
                </a>
                <a href="mailto:hello@lotuslife.bg" className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-full gradient-purple flex items-center justify-center shrink-0">
                    <Mail className="w-5 h-5 text-primary-foreground" />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground font-body">Email</p>
                    <p className="font-medium group-hover:text-primary transition-colors">hello@lotuslife.bg</p>
                  </div>
                </a>
            ...
            >
              <form onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-8">
                ...
                <div className="space-y-5">
                  <div>
                    <label className="text-sm font-body text-muted-foreground block mb-2">Name</label>
                    <Input
                      value={formData.name}
                  ...
                  <div>
                    <label className="text-sm font-body text-muted-foreground block mb-2">Email</label>
                    <Input
                      type="email"
                  ...
                  <div>
                    <label className="text-sm font-body text-muted-foreground block mb-2">Message</label>
                    <Textarea
                  ...
                  <Button type="submit" className="w-full gradient-purple text-primary-foreground border-0 hover:opacity-90">
