    ...
    <Layout>
      <div ref={introScope}>
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_0%_0%,rgba(255,255,255,0.35),transparent_55%),radial-gradient(circle_at_100%_50%,rgba(244,197,255,0.28),transparent_55%)] mix-blend-screen opacity-70" />

          <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-accent/20 blur-3xl will-change-transform" />
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-primary/10 blur-3xl will-change-transform" />
        ...
        {/* Our Philosophy + values scroll reveals */}
        <div ref={scrollScope}>
          <section className="ll-philosophy py-24">
            <div className="container mx-auto px-4 max-w-5xl">
              ...
              <div className="ll-values grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  {
                    icon: Leaf,
