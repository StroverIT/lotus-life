...
const AboutPage = () => {
  const shouldAnimate = usePageFirstVisit("about");
  const scope = useAboutAnimations(shouldAnimate);
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {pillars.map((pillar) => (
                <div
                  key={pillar.title}
                  className={cn("aa-value aa-hoverLift rounded-xl bg-card border border-border p-8 text-center hover:shadow-lg hover:border-primary/20 transition-all", shouldAnimate && "opacity-0 translate-y-3")}
                >
