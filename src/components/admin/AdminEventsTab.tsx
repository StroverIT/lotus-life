  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="font-display text-2xl text-foreground">Upcoming Events</h3>
        <Button variant="default" size="sm" onClick={onAddEvent} className="bg-primary hover:bg-primary/90">
          ...
          {events.map((event) => (
            ...
            >
              <div className="flex-1">
                <h4 className="font-display text-xl mb-1 text-foreground">{event.name}</h4>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <Badge className="text-xs flex items-center gap-1 bg-primary/20 text-primary border border-primary/30">
